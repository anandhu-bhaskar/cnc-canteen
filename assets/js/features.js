  ...
  previewNavbar.innerHTML = `
        <div class="container flex text-center jc-ai-center">
            ...
            <div class="site-title flex align-item-center">
                <div>
                    <a href="index.html"><h1><span class="clr-red">CNC</span> <span class="clr-green">Canteen</span></h1></a>
                </div>
                <!-- Toggle Bars -->
  ...
  signUp_UI = signUpModal.innerHTML = `
    <div class="modal-container">
        ...
        <div class="modal-content">
            <div class="md">Welcome to <br><span class="clr-red md">CNC</span> <span class="clr-green md">Canteen</span></div>
      ...
      element.innerHTML = `
            ...
            <!-- Upper Footer -->
                ...
                <main class="deep-devs flex">
                    ...
                    <div class="">Designed & Developed By <a href="#">Gouri</a></div>
                </main>
            </section>
        `;
    });
                ...
                <main class="grid grid-3">
                    ...
                    <article class="quick-links">
                        <ul>
                            ...
                            <li><a href="https://cnc.com" target="_blank">CNC</a></li>
                        </ul>
                    </article>
                    <!-- Contact Details -->
                    <article class="contact">
                        <ul>
                            ...
                            <li> <i class="fas fa-envelope"></i> <p>admission@cnc.com</p></li>
                            <li> <i class="fas fa-map-marker-alt"></i> <p>Maranallor, Trivandrum -95512</p></li>
                            <li> <i class="fas fa-globe-asia"></i> <p>For Professional Courses, Visit: www.cnc.ac.in</p></li>
                        </ul>
                    </article>
                </main>
                <!-- Deep Devs Info -->
